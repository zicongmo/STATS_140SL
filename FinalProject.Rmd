...
# This dataset has 37172 rows, compared to the ~40000 of the entire dataset
# summary(apartment)

########## FITTING THE MODEL ##########
# Linear regression, just initially see which values are significant (there gon be a lot)
model <- lm(log_price ~ ., data = apartment)
summary(model)
...
predict(model_ridge, s = opt_lambda, type = "coefficients")
...
predict(model_lasso, s = opt_lambda_lasso, type = "coefficients")
